...
const L06 = {
  ...
  newItems: [
    ...
    { id: "L06-07", promptEn: "The money (SV slang)", targetEs: "el pisto", standardEs: "dinero", pronunciation: "PEES-toh", culturalNote: "Very Salvadoran — everyone says pisto instead of dinero" },
...
const L08 = {
  ...
  newItems: [
    ...
    { id: "L08-03", promptEn: "The head", targetEs: "la cabeza", pronunciation: "lah kah-BEH-sah" },
    ...
    { id: "L08-07", promptEn: "The pills / the medicine", targetEs: "las pastillas", pronunciation: "pahs-TEE-yahs" },
    { id: "L08-08", promptEn: "I need", targetEs: "Necesito", pronunciation: "neh-seh-SEE-toh" },
    { id: "L08-09", promptEn: "The hospital / the clinic", targetEs: "el hospital", pronunciation: "ehl ohs-pee-TAHL" },
...
const L09 = {
  ...
  newItems: [
    ...
    { id: "L09-08", promptEn: "The summer", targetEs: "el verano", pronunciation: "veh-RAH-noh", culturalNote: "In SV, 'verano' = dry season (Nov-Apr), 'invierno' = rainy season (May-Oct)" },
...
const L10 = {
  ...
  newItems: [
    ...
    { id: "L10-02", promptEn: "The party", targetEs: "la fiesta", pronunciation: "fee-EHS-tah" },
    ...
    { id: "L10-05", promptEn: "The beer", targetEs: "la cerveza", pronunciation: "sehr-VEH-sah" },
